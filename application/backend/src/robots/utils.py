...
from schemas.robot import Robot, RobotType, NetworkIpRobotConfig
...
async def get_robot_client(
    ...
    elif robot.type == RobotType.TROSSEN_WIDOWXAI_FOLLOWER:
