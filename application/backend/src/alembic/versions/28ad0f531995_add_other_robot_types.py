...
down_revision: Union[str, Sequence[str], None] = 'b4d12e6dce4e'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('project_robots', schema=None) as batch_op:
        ...
        batch_op.alter_column('type',
               ...
               type_=sa.Enum('SO101_FOLLOWER', 'SO101_LEADER', 'TROSSEN_WIDOWXAI_LEADER', 'TROSSEN_WIDOWXAI_FOLLOWER', name='robottype'),
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('project_robots', schema=None) as batch_op:
        ...
        batch_op.alter_column('type',
               existing_type=sa.Enum('SO101_FOLLOWER', 'SO101_LEADER', 'TROSSEN_WIDOWXAI_LEADER', 'TROSSEN_WIDOWXAI_FOLLOWER', name='robottype'),
