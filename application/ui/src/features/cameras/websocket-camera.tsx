...
import { SchemaIpCameraInput, SchemaUsbCameraCameraInput } from '../../api/openapi-spec';
...
export const WebsocketCamera = ({ camera, empty = false }: { camera: CameraFeedProps; empty?: boolean }) => {
    ...
    const params: SchemaUsbCameraCameraInput | SchemaIpCameraInput = {
        id,
        name: camera.name,
