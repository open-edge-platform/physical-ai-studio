...
r"""Unified CLI for getiaction extending LightningCLI with benchmark support.

This module provides `GetiActionCLI` - a custom CLI class that extends LightningCLI
...
- Uses getiaction.train.Trainer by default
...
class CLI(LightningCLI):
    ...
    def __init__(
        ...
        **kwargs: Any,  # noqa: ANN401
        ...
        """Initialize GetiActionCLI with benchmark support."""
    ...
    def _create_benchmark_parser(self, **kwargs: Any) -> LightningArgumentParser:  # noqa: ANN401, PLR6301
        ...
        """
        from getiaction.benchmark import Benchmark  # noqa: PLC0415
...
def cli() -> None:
    ...
    getiaction policies, data modules, and trainer.
    """
    CLI(
        model_class=Policy,
