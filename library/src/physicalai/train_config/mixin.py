...
utilities in :mod:`physicalai.train_config.instantiate` and the dataclass conversion
utilities in :mod:`physicalai.train_config.serializable`. The mixin and decorator
...
from physicalai.train_config.serializable import dataclass_to_dict
