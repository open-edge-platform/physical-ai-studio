...
class PaliGemmaWithExpertModel(nn.Module):
    ...
    def __init__(
        ...
        self.paligemma = PaliGemmaForConditionalGenerationWithPiGemma(config=vlm_config_hf) # pyrefly: ignore[bad-argument-type]
    ...
    def embed_image(self, image: torch.Tensor) -> torch.Tensor:
        ...
        features = image_outputs * self.paligemma.config.text_config.hidden_size**0.5 # pyrefly: ignore[missing-attribute]
