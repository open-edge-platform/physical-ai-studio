...
class Pi0InferenceWrapper(torch.nn.Module):
    ...
    def forward(self, images, img_masks, lang_tokens, lang_masks):
        ...
        out = self.model.sample_actions(images, img_masks, lang_tokens, lang_masks)
...
T_lang = 48 # set token length to 48 for PTQ calibration on libero 
...
torch.onnx.export(
    ...
    input_names=["images", "img_masks", "lang_tokens", "lang_masks"],
