...
from .xr1 import XR1, XR1Config, XR1Model

__all__ = [
    # Bare family names sort ahead of the CamelCase config/model classes (RUF022).
    "ACT",
    "XR1",
    # ACT
    "ACTConfig",
...
def get_policy(policy_name: str, *, source: str = "physicalai", **kwargs) -> Policy:  # noqa: ANN003
    ...
    Args:
        policy_name: Name of the policy to create. Supported values depend on source:
            - physicalai: "act", "dummy", "groot", "pi0", "pi05", "smolvla", "xr1"
...
def get_physicalai_policy_class(policy_name: str) -> type[Policy]:
    ...
    if policy_name == "xr1":
        return XR1
    msg = f"Unknown physicalai policy: {policy_name}. Supported policies: act, dummy, groot, pi0, pi05, smolvla, xr1"
    raise ValueError(msg)
