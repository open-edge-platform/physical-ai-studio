      ...
      <Flex direction={"column"} maxWidth="1320px" flex={0}>
        <View padding="size-400">
          <Flex direction={"column"} alignItems={"center"}>
            ...
            <Text UNSAFE_style={{ textAlign: "center" }}> Fusce vel imperdiet tellus. Nullam pulvinar sodales mauris. Sed vel euismod libero. Duis condimentum, dolor finibus volutpat euismod, lorem nibh auctor sapien, eu vulputate dui nisi ac dui. Cras gravida id erat non vulputate. Phasellus at pulvinar justo, vitae ornare justo. Curabitur id ultrices dui, volutpat venenatis magna. Aliquam facilisis, erat nec vehicula tincidunt, ipsum ipsum bibendum ex, at sagittis mi magna et lacus. Nunc in lacinia metus. Aenean sodales lectus at massa finibus vestibulum. Curabitur quis eros interdum, lacinia ante eget, molestie sem. </Text>
          </Flex>
        </View>
