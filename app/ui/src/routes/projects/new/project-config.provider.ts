...
import { SchemaCalibrationConfig, SchemaCameraConfig, SchemaProjectConfig, SchemaRobotConfig, SchemaRobotPortInfo } from "../../../api/openapi-spec";
...
function createEmptyProject(name: string): SchemaProjectConfig {
  ...
  return {
    ...
    robots: [
      ...
      createEmptyRobot({type: "leader"}),
    ]
  };
}

export function createProjectDataContext(): ProjectDataContext {
